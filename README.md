...
## Future Plans?
I plan to add more features to the website, user authentication, working admin section, payment processing, pages in Footer, and more.

## Functions
cd frontend > npm run dev <br>
cd backend > npm run dev# ChaseNorth_test

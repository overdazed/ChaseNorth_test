...
const NightHomeLoader = () => {
  ...
  return (
      <StyledWrapper $isNightTime={isNightTime}>
        <div className="scene">
...
const StyledWrapper = styled.div`
  ...
  .left-door .time-wrapper {
    ...
    .time {
      ...
      .night {
        opacity: ${({ isNightTime }) => isNightTime ? '1' : '0'};
        ...
        .star {
          ...
          background: #fff;
          border-radius: 50%;
          animation: twinkle 2s -4s infinite;
          ...
          &.star3 { bottom: 25%; left: 30%; animation-delay: 1s; }
          &.star4 { top: 40%; right: 15%; animation-delay: 1.5s; }
          &.star5 { bottom: 35%; left: 15%; animation-delay: 0.8s; }
          &.star6 { top: 25%; left: 50%; animation-delay: 0.3s; }
          &.star7 { bottom: 25%; right: 20%; animation-delay: 1.2s; }
        }
      }
    }
...
export default NightHomeLoader;

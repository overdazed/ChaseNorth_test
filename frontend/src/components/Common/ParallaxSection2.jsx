...
const ParallaxSection2 = () => {
  ...
  return (
    ...
    >
      ...
      <p className="absolute text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-3xl z-10 text-left top-[88%] sm:top-[89%] md:top-[87%] lg:top-[86%] xl:top-[85%] left-6 right-6 transform -translate-y-1/2 w-auto">

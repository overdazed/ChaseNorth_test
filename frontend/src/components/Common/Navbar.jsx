    ...
    return (
        <>
            ...
            >
                ...
                {/* Social Media Links */}
                <div className="mt-auto pt-4 pb-8 border-t border-neutral-200 dark:border-neutral-800">
                    {/* Language Selector */}
                    <div className="relative group mb-6">
                        ...
                        <div className="absolute bottom-full left-0 right-0 mb-1 hidden group-hover:block bg-white dark:bg-neutral-900 rounded-lg shadow-lg overflow-hidden z-10">
                            <button 
                    ...
                    <div className="flex justify-center space-x-6">
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-neutral-700 dark:text-neutral-400 hover:text-black dark:hover:text-neutral-300">
                        ...
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-neutral-700 dark:text-neutral-400 hover:text-black dark:hover:text-neutral-300">
                            <span className="sr-only">Facebook</span>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                            </svg>
                        </a>
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-neutral-700 dark:text-neutral-400 hover:text-black dark:hover:text-neutral-300">

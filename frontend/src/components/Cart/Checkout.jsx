            ...
            <div className="lg:ml-[25px] xl:ml-[50px] 2xl:ml-[50px] lg:mr-[50px] xl:mr-[100px] 2xl:mr-[250px] bg-neutral-50 dark:bg-neutral-900 p-6 rounded-lg shadow dark:shadow-neutral-700">
                ...
                <div className="mb-4 pt-2">
                    <div className="flex">
                        ...
                        />
                        <button
                            className="bg-black text-white px-4 py-2 rounded-r hover:bg-neutral-800 hover:outline-none transition-colors focus:outline-none focus:ring-1 focus:ring-neutral-500 focus:border-transparent"

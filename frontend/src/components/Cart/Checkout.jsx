...
const Checkout = () => {
    ...
    const handleCreateCheckout = async(e) => {
        ...
        if (cart && cart.products.length > 0) {
            ...
            const finalShippingCost = (discountApplied && discountCode.trim().toUpperCase() === import.meta.env.VITE_DISCOUNT_CODE4)
                ? 0
                : ((!discountApplied && subtotal >= 100) ? 0 : cost);  // Apply free shipping if subtotal >= $100 and no discount
...
// Add this handler for the discount code input
    ...
    return (
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 mx-auto py-10 px-6 tracking-tighter dark:bg-neutral-950 min-h-viewport">
            {/* Left Section */}
            <div className="lg:ml-[200px] bg-white dark:bg-neutral-900 rounded-lg p-6 shadow dark:shadow-neutral-700">
                <div className="mb-6">
            ...
            <div className="lg:ml-[200px] bg-neutral-50 dark:bg-neutral-900 p-6 rounded-lg shadow dark:shadow-neutral-700">

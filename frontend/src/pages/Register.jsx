                ...
                <form onSubmit={handleSubmit} className="form">
                    ...
                    <div className="inputForm" style={{ position: 'relative' }}>
                        ...
                        >
                            ...
                            {/*        <path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L381.2 274.7c42.9-39.6 72.2-82.9 86.6-106.7 3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32c-68.2 0-130.8 22.4-181.2 60.1L38.8 5.1zM144 256c0 35.3 28.7 64 64 64h60.2L144 191.8v64.2zm0 0v64.2c0 35.3 28.7 64 64 64h160c25.9 0 48.6-15.5 58.2-38.6L436.6 416h-84.6c-10.2 0-18.4 8.3-18.4 18.4c0 6.5 3.4 12.5 9 15.9l84 58.8c5.6 3.9 12.9 3.1 17.8-1.9l39.6-39.6c4.9-4.9 4.9-12.9 0-17.9L38.8 5.1 9.2 34.7 144 169.5v86.5z" />*/}
                            {/*    </svg>*/}
                            {/*) : (*/}
                    ...
                    <button type="submit" className="button-submit" disabled={isSigningUp}>

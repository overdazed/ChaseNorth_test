        ...
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-3">
            <div className="bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                We are here to assist you with any questions or concerns. Reach out to us via email or phone, and we will respond as soon as possible.
              </p>
              <ul className="list-disc pl-5 text-neutral-600 dark:text-neutral-300 mb-4">
                <li>Email: <a href="mailto:support@chasenorth.com" className="text-blue-600 dark:text-blue-400">support@chasenorth.com</a></li>
                <li>Phone: +1 (123) 456-7890</li>
                <li>Address: 123 Adventure Lane, Outdoor City, OC 12345</li>
              </ul>
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">

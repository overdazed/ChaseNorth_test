            ...
            <FormContainer>
                <form onSubmit={handleSubmit} className="form">
                    ...
                    <div className="inputForm">
                        ...
                        />
                        <svg className="pr-2" viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button type="submit" className="button-submit" disabled={isLoggingIn}>
                        {isLoggingIn ? 'Loading...' : 'Sign In'}
                    </button>
                    <p className="p">
                        Don't have an account?{" "}
                        <Link to={`/register?redirect=${encodeURIComponent(redirect)}`} className="span">
                            Sign Up
                        </Link>
                    </p>

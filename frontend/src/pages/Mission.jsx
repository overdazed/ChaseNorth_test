        ...
        <div className="grid md:grid-cols-5 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="hidden md:block mt-12 shadow-md bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                If you have any further questions about our mission, our customer support team is here to help.
              </p>
          ...
          <div className="md:col-span-3">
            <div className="bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                At ChaseNorth, our mission is to provide high-quality outdoor gear that inspires adventure and exploration. We are committed to sustainability, innovation, and customer satisfaction.
              </p>
              <ul className="list-disc pl-5 text-neutral-600 dark:text-neutral-300 mb-4">
                <li>Sustainability: We prioritize eco-friendly materials and ethical manufacturing.</li>
                <li>Innovation: We continuously improve our products to meet the needs of modern adventurers.</li>
                <li>Customer Satisfaction: Your experience and feedback drive our improvements.</li>
              </ul>
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                To learn more about our mission, please contact us at <a href="mailto:support@chasenorth.com" className="text-blue-600 dark:text-blue-400">support@chasenorth.com</a>.
              </p>
            </div>
          </div>
        </div>

        ...
        <div className="grid md:grid-cols-5 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="hidden md:block mt-12 shadow-md bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                If you have any further questions about our delivery options, our customer support team is here to help.
              </p>
          ...
          <div className="md:col-span-3">
            <div className="bg-neutral-100 dark:bg-neutral-800 p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 mb-4">
                We offer a variety of delivery options to ensure your order arrives on time and in perfect condition. Choose the option that best suits your needs.
              </p>
